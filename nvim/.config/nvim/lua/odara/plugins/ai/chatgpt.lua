return {
  ...
  enabled = vim.g.odara.plugins.chatgpt_nvim
    and vim.g.odara.plugins.nui_nvim
    and vim.g.odara.plugins.plenary_nvim
    and vim.g.odara.plugins.trouble_nvim
    and vim.g.odara.plugins.telescope_nvim,
