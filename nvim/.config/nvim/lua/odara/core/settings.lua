vim.g.odara = {
  ...
  plugins = {
    ...
    snacks_nvim = {
      -- NOTE:   Módulo de animação para efeitos suaves no Neovim.
      --   Permite transições suaves em UI, como janelas e menus.
      --   Utiliza interpolação para criar animações fluídas.
      --   Configurável para diferentes velocidades e estilos de animação.
      --   Documentação: https://github.com/folke/snacks.nvim/blob/main/docs/animate.md
      animate = false,
      bigfile = false,
      bufdelete = false,
      dashboard = false,
